...
void runFlow(Bool_t etaFlag = kTRUE, TString centrality="", Double_t gCentrality=30, Int_t iGroupMin=0, Int_t iGroupMax=2000, Double_t gSpectatorMin=0, Double_t gSpectatorMax=500) {
